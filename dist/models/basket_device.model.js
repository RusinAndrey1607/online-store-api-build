...
class BasketDeviceModel {
    ...
    delete(body) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield db_1.pool.query(`DELETE FROM basket_devices WHERE device_id = ${body.device_id} AND basket_id=${body.basket_id};`);
        });
    }
    getItems(basket_id) {
        return __awaiter(this, void 0, void 0, function* () {
    ...
    create(body) {
        return __awaiter(this, void 0, void 0, function* () {
            return (yield db_1.pool.query(`INSERT INTO basket_devices (device_id,basket_id) VALUES (${body.device_id},${body.basket_id}) RETURNING id, basket_id,device_id;`)).rows[0];
        });
    }
}
